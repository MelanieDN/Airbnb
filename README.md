...
- **Processing:** Python / Pandas (Exploratory Data Analysis) / dbt
...
- `Notebooks/`: Python script for exploratory data analysis.
- `models/`: Includes the scripts used for data cleaning and calculated fields.
- `Assets/`: Screenshots of the dashboard.

## 🎯Conclusions

**Travelers favor good value for money without necessarily seeking neither luxury nor the cheapest**
